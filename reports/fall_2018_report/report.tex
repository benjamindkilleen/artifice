...
\begin{figure*}
  \centering
  \subfloat[]{
    \includegraphics[width=0.4\linewidth]{traditional_graph}
    \label{fig:traditional-graph}
  }
  \hspace{0.1\linewidth}
  \subfloat[]{
    \includegraphics[width=0.4\linewidth]{artifice_graph}
...
\begin{figure}
  ...
  \subfloat[Gyroscopic Model]{
    \includegraphics[width=0.4\linewidth]{gyros}
    \label{fig:gyros}
  }
  \hspace{0.1\linewidth}
  \subfloat[Coupled Spheres]{
    \includegraphics[width=0.4\linewidth]{coupled_spheres}
